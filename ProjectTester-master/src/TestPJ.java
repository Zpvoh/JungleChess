...
public class TestPJ {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "E:\\Project1\\JungleChess\\JungleChess(edit)";

        //classpath是IntelliJ在你pj编译完后生成的.class文件的文件夹。一般在工程目录的out目录的production目录下
        String classpath = "E:\\Project1\\JungleChess\\JungleChess(edit)\\out\\production\\JungleChess";
        ...
        //以\\结尾
        String testPath = "E:\\Project1\\JungleChess\\ProjectTester-master\\";
